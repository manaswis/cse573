...
class Model(torch.nn.Module):
    def __init__(self, args):
        ...
        # Organick
        self.additional_state_size = 1 # Organick
        self.augmented_hidden_size = 2 # Organick
    ...
    def embedding(self, state, additional_state_info):
        ...
        x = x.view(x.size(0), -1)
        #return x
        additional_score = self.augmented_linear(torch.FloatTensor(additional_state_info).cuda())  # Organick
